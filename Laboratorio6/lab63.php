...
echo "<br>Precio: " . $soporte1->dame_precio_sin_itbm() . " dólares";
echo "<br>Precio ITBM incluido: " . $soporte1->dame_precio_con_itbm() . " dólares";


$mivideo = new video("Los Otros", 22, 4.5, "115 minutos");
echo "<br><br>";
echo "<b>" . $mivideo->titulo . "</b>";
echo "<br>Precio: " . $mivideo->dame_precio_sin_itbm() . " dólares";
echo "<br>Precio ITBM incluido: " . $mivideo->dame_precio_con_itbm() . " dólares  ";
